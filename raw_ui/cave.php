        ...
        <div class="panel-body">
          ...
          <!--<div class="row">    
            ...
            <div class="col-md-2 col-sm-3 text-center">
              <a class="story-title" href="#"><img alt="" src="img/badges.png" style="width:130px;" class="img-circle"></a>
            </div>
            <div class="col-md-10 col-sm-9">
              <h3>Badges</h3>
              <div class="row">
                <div class="col-xs-9">
                  <h4><span class="label label-default">3 Badges Earned</span></h4></div>
